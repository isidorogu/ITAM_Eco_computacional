...
### Cómo vamos a `Git` y `Github` en Eco-Computacional

Yo subiré las tareas. Ustedes deben hacer `git pull` a su computadora para obtener los archivos. Crear su branch (nombre = tarea_#_clave_unica). Despues hacer push del branch al repo. Yo podré revisar el codigo en `Github`. 
